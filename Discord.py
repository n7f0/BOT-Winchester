...
CANAL_RESERVAS_CLIENTES_ID = 1516463426396749844  # NOVO canal fixo para reservas clientes
...
# ========= MODAL DE FARM PRODUTOS (5 CAMPOS - SEM CARTEIRA NFT) =========
class FarmProdutosModal(Modal, title="📦 Depositar Farm"):
    ...
    # CARTEIRA NFT removido para manter 5 campos (limite do Discord)
...
async def on_ready():
    ...
    for guild in bot.guilds:
        ...
        # Painel de Reservas (Clientes) - canal fixo
